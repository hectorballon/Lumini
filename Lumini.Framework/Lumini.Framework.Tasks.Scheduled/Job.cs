    ...
    public class Job : IMergeableJob, ICloneable
    {
        ...
        private void StartTask(Occurrence occurrence)
        {
            try
            {
                ...
                //    return null;
                //}
                //CurrentTask = Trigger?.RunAync(_cts.Token);
                //if (Type == JobType.OnDemand)
                //    return CurrentTask.ContinueWith(_ => CurrentTask = null);
                ...
                //    return CurrentTask.ContinueWith(_ => CurrentTask = null);
                //return CurrentTask.ContinueWith(async _ =>
                //    await StartTask(nextOccurrence)
                //);
            }
            catch (Exception e)
            {
